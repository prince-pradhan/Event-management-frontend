        ...
        <div className="container-app py-12 max-w-5xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                <div>
                    ...
                    <p className="mt-2 text-slate-600">Fill in the details below to publish a new event.</p>
                </div>
                <div className="flex gap-3">
                    <Button variant="secondary" onClick={() => navigate(ROUTES.ADMIN_EVENTS)}>Cancel</Button>
                    <Button type="submit" form="create-event-form" disabled={loading} className="px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white shadow-lg shadow-primary-500/30">
            ...
            {error && (
                <div className="mb-8 p-4 bg-red-50 text-red-700 rounded-xl border border-red-100 flex items-start gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold">Unable to create event</h3>
                        <p className="text-sm opacity-90">{error}</p>
                    </div>
                </div>
            )}

            <form id="create-event-form" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="space-y-4 pt-4 border-t border-slate-100">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Grand Hall, City Convention Center"
                                />
                            </div>
